...
| File | Responsibility |
|---|---|
| `../../backend/app/App.tsx` — `AdminPage` | The 6-tile hub. |
| `../../backend/app/App.tsx` — `AuditLogPage`, `AlertRulesPage`, `RiskModelsPage` | Pre-existing sub-pages (unchanged). |
| `../../backend/app/pages/admin/UserManagementPage.tsx` | Users / Roles / Groups / SSO-Directory — new. |
| `../../backend/app/pages/admin/CompliancePoliciesPage.tsx` | Policy CRUD — new. |
| `../../backend/app/pages/admin/IntegrationsPage.tsx` | Integration configuration — new. |
| `../../backend/app/components/Modal.tsx` | Shared `Modal`, `ModalFooter`, `FormField`, `inputClass` used by every CRUD form below. |
...
`../../backend/app/pages/admin/UserManagementPage.tsx` — 4 internal tabs (local `tab`
...
`../../backend/app/pages/admin/CompliancePoliciesPage.tsx`
...
`../../backend/app/pages/admin/IntegrationsPage.tsx`
